          ...
          <div className="p-4 flex-grow">
            ...
            {userProfile && user && (
              <div>
                ...
                <CustomButton
                  ...
                  className="customButton customButtonSmall mb-3 mr-3"
                >
                  Edit Personal Info
                </CustomButton>
                <CustomButton
                  onClick={() => setIsOpenModal(true)}
                  className="customButton mb-3 customButtonSmall mt-2"
                >
            ...
            <div className="flex">
              <CustomButton
                ...
                className="customButton customButtonSmall mr-3"
              >
                Change Email
              </CustomButton>
              <CustomButton
