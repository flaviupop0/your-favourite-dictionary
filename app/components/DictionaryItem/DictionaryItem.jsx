...
function DictionaryItem({ dictionary, onDelete, userId }) {
  ...
  return (
    <div className="relative inline-block mr-2">
      <div
        className="p-4 border border-gray-300 rounded-lg shadow-md cursor-pointer block"
        style={{
          width: "200px",
          height: "150px",
          verticalAlign: "top",
          backgroundImage: `linear-gradient(to top, #f0f0f0, ${color})`,
        }}
      >
