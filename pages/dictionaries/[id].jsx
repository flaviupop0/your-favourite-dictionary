    ...
    <div className="min-h-screen bg-white text-black flex flex-col">
      <Navbar>
        <>
          <MenuButton
            onClick={handleClick}
            className="customIcons text-white"
          />
          <SlidingMenu
            userId={userId}
              ...
              <div className="bg-white rounded-lg shadow-md p-5 relative">
                ...
                <div className="z-10 relative">
                  {dictionary.words.map((word, index) => (
                    <div
                      key={index}
                      className={`border-b border-gray-200 p-4 ${index === searchedIndex ? "highlighted" : ""}`}
                    >
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="font-semibold text-xl word">
                            {word.name}
                          </p>
                        ...
                        <div className="flex items-center space-x-4">
                          <button
                            className="ml-4 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-2 rounded flex items-center"
                          ...
                          <button
                            className="ml-4 bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-2 rounded flex items-center"
